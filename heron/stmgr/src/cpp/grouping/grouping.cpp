...
unique_ptr<Grouping> Grouping::Create(proto::api::Grouping grouping_,
  ...
  switch (grouping_) {
    case proto::api::SHUFFLE: {
      return std::make_unique<ShuffleGrouping>(_task_ids);
      break;
    }

    case proto::api::FIELDS: {
      return std::make_unique<FieldsGrouping>(_is, _schema, _task_ids);
      break;
    }

    case proto::api::ALL: {
      return std::make_unique<AllGrouping>(_task_ids);
      break;
    }

    case proto::api::LOWEST: {
      return std::make_unique<LowestGrouping>(_task_ids);
      break;
    }
    ...
    case proto::api::DIRECT: {
      return std::make_unique<DirectGrouping>(_task_ids);
      break;
    }

    case proto::api::CUSTOM: {
      return std::make_unique<CustomGrouping>(_task_ids);
      break;
    }
