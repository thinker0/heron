...
env | grep -E '^(TARGET_PLATFORM|SCRATCH_DIR|SOURCE_TARBALL|OUTPUT_DIRECTORY|HERON_VERSION|HERON_GIT_REV|HERON_BUILD_VERSION|HERON_BUILD_HOST|HERON_BUILD_USER|HERON_BUILD_TIME|HERON_TREE_STATUS)='
